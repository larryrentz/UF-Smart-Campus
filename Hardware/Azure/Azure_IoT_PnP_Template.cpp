...
/* #define TELEMETRY_PROP_NAME_LIGHT                      "LED3"
#define TELEMETRY_PROP_NAME_PRESSURE                   "LED4"
...
static int generate_telemetry_payload(uint8_t* payload_buffer, size_t payload_buffer_size, size_t* payload_buffer_length)
{
  ...
  LED1 = simulated_get_temperature();
  ...
  rc = az_json_writer_append_double(&jw, LED1, DOUBLE_DECIMAL_PLACE_DIGITS);
