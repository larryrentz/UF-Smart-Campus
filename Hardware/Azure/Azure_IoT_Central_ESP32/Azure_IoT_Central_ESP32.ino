...
void loop()
{
  ...
  else
  {
    ...
    //count = digitalRead(35); //test input
    ...
    onLED1MOSFETSTATEChange();
    onLED2MOSFETSTATEChange();
    onLED3MOSFETSTATEChange();
    onLED4MOSFETSTATEChange();

    Serial.print("LED1: ");
    Serial.println(LED1);
    Serial.print("LED2: ");
    Serial.println(LED2);
    Serial.print("LED1 - LEd2: ");
